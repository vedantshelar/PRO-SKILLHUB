...
const { getAllPosts, createNewPost, likePost, unlikePost, uploadPostImgAndContent, destroyPost } = require('../controllers/postControllers');
...
router.post("/:userId/:postId/destroy",isAuthenticatedUser,isPostOwner,destroyPost);
